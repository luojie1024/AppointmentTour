package hnulab.appointmenttour.ui.home;
...
import hnulab.appointmenttour.ui.about.AboutActivity;
import hnulab.appointmenttour.ui.offlinemap.OfflineMapActivity;
import hnulab.appointmenttour.ui.route_plan.RoutePlanActivity;
import hnulab.appointmenttour.ui.search.SearchActivity;
import hnulab.appointmenttour.ui.welfare.WelfatreActivity;
import hnulab.appointmenttour.util.BmbBuilderManager;
    ...
    public void initListener() {
        ...
        viewTreeObserver.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                //存储Bmb的中心坐标
                SPUtil.put(getApplicationContext(), Constant.REVEAL_CENTER_X,(int)(mBmb.getX() + mBmb.getWidth()/2));
                SPUtil.put(getApplicationContext(),Constant.REVEAL_CENTER_Y,(int)(mBmb.getY() + mBmb.getHeight()/2));
            }
        });
        ...
        mFabCheck.setOnClickListener(v -> {
            ...
            if ((boolean) SPUtil.get(getApplicationContext(), Constant.TRAFFIC_ENABLE, true)) {
                mFabCheck.setImageResource(R.mipmap.no_check);
                SPUtil.put(getApplicationContext(), Constant.TRAFFIC_ENABLE, false);
                ...
                SPUtil.put(getApplicationContext(), Constant.TRAFFIC_ENABLE, true);
        ...
        mBmb.setOnBoomListener(new OnBoomListener() {
            ...
            public void onBoomDidHide() {
                ...
                switch (bmbSubClickedIndex){
                    case 0:
                        Toast.makeText(getApplicationContext(),"功能待开发",Toast.LENGTH_SHORT).show();
                        break;
